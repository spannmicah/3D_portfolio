      ...
      <div className="py-6">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p className="text-md ">
            ...
            intelligent people to get a project done. If you would like to see
            my resume please click on this link to download a pdf format of my
            <a
              className="blue-gradient_text font-semibold cursor-pointer"
              href="https://storage.rxresu.me/cm3gf1q9j08jydbpo1omxza9k/resumes/Micah's Resume.pdf"
            >
              {""} resume. {""}
            </a>
          </p>
